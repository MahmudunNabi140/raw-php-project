...
if(isset($_POST['title'])){
    ...
    $query="INSERT INTO `blog` (`id`, `photo`, `add_by`, `title`,`details`,`date`) VALUES (NULL, '$file','$add_by', '$title','$details','$date')";
    $db->query($query);
                    ...
                    <?php $i=0; while($data=$blog->fetch_assoc()){ ?>
                        <tr>
                            ...
                            <td>
                              ...
                              <a href="bolg_delete.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Do you want to delete this ??')" class="btn btn-success btn-xs">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
