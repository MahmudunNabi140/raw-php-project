  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">Add Latest News</h5>
              </div>
              <div class="card-body">
        ...
        <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">Latest News List</h5>
              </div>
              <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <?php $i=0; while($data=$latest_news->fetch_assoc()){ ?>
                        <tr>
                            <td><?php echo ++$i ?></td>
                            ...
                            <td>
                              <a href="latest_news_edit.php?id=<?php echo $data['id'] ?>" class="btn btn-success btn-xs">Edit</a>
                              <a href="latest_news_delete.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Do you want to delete this ??')" class="btn btn-success btn-xs">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
