          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">Add new Project</h5>
              </div>
              <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <?php $i=0; while($data=$project->fetch_assoc()){ ?>
                        <tr>
                            ...
                            <td>
                              <a href="project_edit.php?id=<?php echo $data['id'] ?>" class="btn btn-success btn-xs">Edit</a>
                              <a href="project_delete.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Do you want to delete this ??')" class="btn btn-success btn-xs">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
