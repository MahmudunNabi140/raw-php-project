  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">Add Pricing Plan</h5>
              </div>
              <div class="card-body">
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="support" class="form-control" id="exampleInputEmail1" placeholder="Enter Support" >
                    </div>
                    </div>
                <div class="col-6">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Data_base</label>
                        <input type="text" name="data_base" class="form-control" id="exampleInputEmail1" placeholder="Enter Data_base" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Maintenance</label>
                        <input type="text" name="maintenance" class="form-control" id="exampleInputEmail1" placeholder="Enter Maintenance" >
                    </div>
                    </div>
                <div class="col-6">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Traffic</label>
                        <input type="text" name="traffic" class="form-control" id="exampleInputEmail1" placeholder="Enter Traffic" >
                    </div>
                    <div class="form-group">
        ...
        <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">Pricing Plan List</h5>
              </div>
              <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <?php $i=0; while($data=$pricing_plan->fetch_assoc()){ ?>
                        <tr>
                            ...
                            <td><?php echo $data['data_base'] ?></td>
                            <td><?php echo $data['maintenance'] ?></td>
                            <td><?php echo $data['traffic'] ?></td>
                            <td><img src="../assets/image/<?php echo $data['photo'] ?>" width="100" height="80"/></td>
                            <td>
                              <a href="pricing_plan_edit.php?id=<?php echo $data['id'] ?>" class="btn btn-success btn-xs">Edit</a>
                              <a href="pricing_plan_delete.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Do you want to delete this ??')" class="btn btn-success btn-xs">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
