...
$sirvice=$db->query('select * from service order by id desc');
if(isset($_POST['title'])){
    $t_1=$_POST['title'];
    $details=$_POST['details'];
    $file=$_FILES['photo']['name'];
    move_uploaded_file($_FILES['photo']['tmp_name'],'../assets/image/'.$file);
    $query="INSERT INTO `service` (`id`, `photo`, `title`, `details`) VALUES (NULL, '$file','$t_1', '$details')";
    $db->query($query);
                    ...
                    <?php $i=0; while($data=$sirvice->fetch_assoc()){ ?>
                        <tr>
                            ...
                            <td>
                              ...
                              <a href="service_delete.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Do you want to delete this ??')" class="btn btn-success btn-xs">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
