...
<!-- Mirrored from limty-html.netlify.app/limty/blog-details-no-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Nov 2022 05:08:48 GMT -->
...
<body>
          ...
          <div class="st-nav-wrap st-fade-down">
            ...
            <nav class="st-nav st-desktop-nav">
              <ul class="st-nav-list">
                <li class="st-has-children"><a href="index.html#home">Home</a>
                  <ul>
  ...
  <div class="st-blog-wrap st-section" id="blog">
    <div class="container">
      <div class="row">
      <?php while($da=$blog_details->fetch_assoc()){ ?>
        <div class="col-lg-8 offset-lg-2">
          <article class="post">
          	<header class="entry-header">
          		<div class="post-thumbnail">
          			<img src="assets/image/<?php echo $da['photo']?>" alt="demo">
          		</div>
          		<div class="post-details-wrap-outer">
          			<div class="post-details-wrap">
          				<h2 class="entry-title"><?php echo $da['title']?></h2>
          				<div class="byline">
          					<span class="author">
          						<a href="#" class=""><i class="fa fa-user"></i><?php echo $da['add_by'] ?></a>
          					</span>
          					<span class="posted-on"><i class="fa fa-calendar"></i><?php echo $da['date']?></span>
          					<span><i class="fa fa-tag"></i><a href="#">Support Servides,</a> <a href="#">Digital Marketing</a></span>
          				</div>
          			</div>
          		</div><!-- .post-details-wrap-outer -->
          	</header><!-- .entry-header -->
          	<div class="entry-content">
          		<p><?php echo $da['details']?></p>
          	</div>
          </article>
          <?php }?>
          <div class="comments-area">
          	...
          	<ol class="comment-list">
          			...
          			<div class="comment-body">
          				<div class="comment-meta">
          					<div class="comment-author">
          						<img src="assets/img/light-img/client-1.jpg" alt="demo" class="avatar">
          			...
          			<ol class="children">
          				<li class="comment">
          					<div class="comment-body">
          						<div class="comment-meta">
          							<div class="comment-author">
          								<img src="assets/img/light-img/client-2.jpg" alt="demo" class="avatar">
          		...
          		<li class="comment">
          			<div class="comment-body">
          				<div class="comment-meta">
          					<div class="comment-author">
          						<img src="assets/img/light-img/client-3.jpg" alt="demo" class="avatar">
          	...
          	<div class="comment-respond">
          		...
          		<form method="post" class="comment-form">
          			...
          			<p class="form-submit">
          				<button type="submit" class="st-btn st-style1 st-size1 st-color1"><span>Post Comment</span></button>
          			</p>
          		</form>
          	</div><!-- .comment-respond -->
          </div>
...
<!-- Mirrored from limty-html.netlify.app/limty/blog-details-no-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Nov 2022 05:08:49 GMT -->
</html>
